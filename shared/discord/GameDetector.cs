...
namespace RPCProxy.Shared.Discord
{
  public class GameDetector
  {
    ...
    {
      List<Game> detectList = new List<Game>();
      ...
      try
      {
        ...
        using (HttpRequestMessage request = new HttpRequestMessage())
        {
          ...
          if (response.IsSuccessStatusCode)
          {
            ...
            detectList = JsonConvert.DeserializeObject<List<Game>>(jsonData) ?? new List<Game>();
          }
        }
      }
      catch (HttpRequestException e) {
        // ignore error, but print to console
        this.log?.LogError($"Failed to download list of detectable games.");
      }

      return detectableList!;
    }
...
#pragma warning disable CA1416 // Compiler is annoying
      ...
      {
        Game? detectedGame = this.detectableList!.FirstOrDefault(g => g!.Executables.Any(ex => this.CheckGameFilter(e.NewEvent, ex)), null);
...
#pragma warning restore CA1416
    ...
    private bool CheckGameFilter(ManagementBaseObject baseObject, Executable executable)
    {
#pragma warning disable CA1416 // Compiler is annoying
